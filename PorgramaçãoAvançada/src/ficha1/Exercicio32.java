...
public class App {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tipoCombustivel.length; i++) {
            System.out.println("Digite o tipo de combustÃ­vel preferido: ");
            System.out.println("1 - Ã?lcool / 2 - Gasolina / 3 - Diesel: ");
        ...
        System.out.println("Ã?lcool: " + qtdAlcool + " - Qtd Litros: " + somaLitrosAlcool);
